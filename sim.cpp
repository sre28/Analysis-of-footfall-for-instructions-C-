...
void analyze_trace_record(Trace_Rec *t){
    ...
    if(stat_unique_pc == 0)
    {
    	sre[stat_unique_pc] = t->inst_addr;
    	stat_unique_pc = 1;
	}
	else
	{
    ...
    switch(op_code)
    {
    	case 0: stat_optype_dyn[OP_ALU]++;
    	stat_num_cycle = stat_num_cycle + 1;
    	break;
    	case 1: stat_optype_dyn[OP_LD]++;
    	stat_num_cycle = stat_num_cycle + 2;
    	break;
    	case 2: stat_optype_dyn[OP_ST]++;
    	stat_num_cycle = stat_num_cycle + 2;
    	break;
    	case 3: stat_optype_dyn[OP_CBR]++;
    	stat_num_cycle = stat_num_cycle + 3;
    	break;
    	case 4: stat_optype_dyn[OP_OTHER]++;
    	stat_num_cycle = stat_num_cycle + 1;
    	break;
